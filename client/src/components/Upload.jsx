...
const Upload = () => {
  return (
    <div className='pb-16'>
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r bg-clip-text text-transparent py-6 md:py-16 bg-gray-800'> See the magic. Try now</h1>
